...
const BATTLE_STEPS = [
  '⚔️ INITIATING ARC CREATOR CLASH...',
  '⚡ BENCHMARKING SUB-SECOND IMPACT & TPS...',
      ...
      <div className="feature-header-wrap">
        ...
        {battleStage === 'revealed' && (
          ...
          >
            ...
            <span>
              {winner === 1
                ? `👑 @${user1Data?.user?.handle} CLAIMS THE ARC ARENA CROWN!`
                : winner === 2
                ? `👑 @${user2Data?.user?.handle} CLAIMS THE ARC ARENA CROWN!`
